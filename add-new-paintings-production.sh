...
# Script to add new paintings to production database via API
BACKEND_URL="https://docker-composeyaml-production.up.railway.app"

echo "Adding new Occupations paintings to production..."
...
echo ""
echo "Adding new Vehicles paintings to production..."
...
echo ""
echo "Adding new Mandalas paintings to production..."
...
echo ""
echo "✅ All new paintings added to production!"
